...
import com.payswitch.iso.handler.ReconnectOnCloseListener;
...
public class BaseClient<T extends IsoMessage> extends AbstractIso8583Connector<ClientConfiguration, Bootstrap, T> {

    private ReconnectOnCloseListener reconnectOnCloseListener;

    public BaseClient(SocketAddress socketAddress, ClientConfiguration config, MessageFactory<T> isoMessageFactory) {
        super(config, isoMessageFactory);
        setSocketAddress(socketAddress);
    }

    public BaseClient(SocketAddress socketAddress, MessageFactory<T> isoMessageFactory) {
     ...
     */
    @Deprecated
    public BaseClient(MessageFactory<T> isoMessageFactory) {
    ...
    protected Bootstrap createBootstrap() {
        ...
        b.group(getBossEventLoopGroup())
                ...
                .handler(new IsoChannelInitializer<>(
                        getConfiguration(),
                        getConfigurer(),
