...
import com.payswitch.iso.connection.BaseClient;
...
public class ReconnectOnCloseListener implements ChannelFutureListener {
    ...
    public ReconnectOnCloseListener(BaseClient client, int reconnectInterval, ScheduledExecutorService executorService) {
        this.client = client;
